...
@pytest.fixture
def niceloop_puzzle0_1(niceloop_puzzle0_sol):
    p = """
-----------------------------------------------------------------------------------------------
|| 2  567  |    567  |12       ||        9|  3 5678 |  3 5 7  ||   4     |123   7  |12    78 ||
|| 2 4 67 9|   4 67 9|       8 ||  3  6   |1        |  34  7  ||    5    | 23   7 9| 2    7 9||
||  3      |   45 7 9|1  4    9||    5  8 |   45 78 | 2       ||      78 |     6   |1     789||
-----------------------------------------------------------------------------------------------
|| 2 456   |  3456   |      7  ||1        | 23 5    |        9|| 23  6   |       8 | 2 456   ||
|| 2  5  89|  3 5  89| 23     9||   4     | 23 5 78 |     6   || 23   7  |123 5 7  |12  5 7  ||
|| 2 456 8 |1        | 234     || 23 5  8 | 23 5 78 |  3 5 7  ||        9| 2345 7  | 2 4567  ||
-----------------------------------------------------------------------------------------------
||   4   89| 2       |   4    9||      7  |   456   |1        ||     6 8 |   45   9|  3      ||
||   4  78 |  34  78 |    5    || 23  6   |        9|  34     ||1        | 2 4  7  | 2 4 678 ||
||1        |  34  7 9|     6   || 23 5    | 2345    |       8 || 2    7  | 2 45 7 9| 2 45 7 9||
-----------------------------------------------------------------------------------------------
"""
    P = sudoku.read_possibilities(p)
    P.solution = niceloop_puzzle0_sol
    return P


@pytest.fixture
def niceloop_puzzle0_2(niceloop_puzzle0_sol):
    p = """
-----------------------------------------------------------------------------------------------
|| 2  567  |    567  |12       ||        9|  3 5678 |  3 5 7  ||   4     |123   7  |12    78 ||
|| 2 4 67 9|   4 67 9|       8 ||  3  6   |1        |  34  7  ||    5    | 23   7 9| 2    7 9||
